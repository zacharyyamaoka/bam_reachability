...
# COPIED FROM https://github.com/GouMinghao/rgb_matters/blob/main/rgbd_graspnet/data/utils/generate_anchor_matrix.py
...
if __name__ == "__main__":
    ...
    # Rs = Rs[0:20]
    from vis_label import plot_gripper_pro_max

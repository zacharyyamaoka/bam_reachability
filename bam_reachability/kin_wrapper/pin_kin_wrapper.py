...
class PinKinWrapper(KinWrapper):
...
if __name__ == '__main__':
    ...
    # kinematics = PinKinWrapper(robot_name="panda", base_link="panda_link0", ik_tip_link="panda_link7")
